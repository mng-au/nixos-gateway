# Originally from nixpkgs, (c) 2003-2026 Eelco Dolstra and the Nixpkgs/NixOS contributors
...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.adguardhome = {
      ...
      # Copy readonly sops secret template to runtime directory and make it modifiable
      preStart = ''
cp --force "${config.sops.templates."AdGuardHome.yaml".path}" "$STATE_DIRECTORY/AdGuardHome.yaml"
